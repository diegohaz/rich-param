...
test('constructor type', (t) => {
  ...
  t.same(type({ foo: 'bar' }), Object, 'should set type object automatically')
  t.same(type([{ foo: 'bar' }]), Object, 'should set type object automatically by array')
...
test('constructor options with multiple value', (t) => {
...
test('value', (t) => {
  ...
  t.same(dateValue('2016-04-24'), date, 'should convert same string to date')
...
test('value with multiple value', (t) => {
...
test('validate with multiple value', (t) => {
...
test('option', (t) => {
  ...
  t.true(param().option('separator'), 'should get an option')
